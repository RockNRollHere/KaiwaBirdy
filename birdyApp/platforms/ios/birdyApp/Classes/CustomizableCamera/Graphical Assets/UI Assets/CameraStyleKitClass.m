...
+ (void)drawCameraShutterWithFrame: (CGRect)frame
{
    ...
    UIColor* color1 = [UIColor colorWithRed: 0.6 green: 0.612 blue: 0.612 alpha: 0.8];
    ...
    //// Page-1
    {
        //// Portrait
        {
            ...
            UIBezierPath* cameraShutterVectorPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(CGRectGetMinX(page1) + floor(CGRectGetWidth(page1) * 0.00000 + aPx), CGRectGetMinY(page1) + floor(CGRectGetHeight(page1) * 0.00000 + aPx), floor(CGRectGetWidth(page1) * 1.00000 + aPx) - floor(CGRectGetWidth(page1) * 0.00000 + aPx), floor(CGRectGetHeight(page1) * 1.00000 + aPx) - floor(CGRectGetHeight(page1) * 0.00000 + aPx))];
            [color0 setFill];
